...
router.patch('/profile', checkAuth, updateOwnDate)
router.patch('/profile/:id', checkAuth, checkRole, updateAdateByUserId)
router.delete('/profile', checkAuth, deleteAllOwnDates)
router.delete('/profile/:id', checkAuth, deleteOwnDate)
router.delete('/profile/:id', checkAuth, checkRole, deleteAlldatesByUserId)
